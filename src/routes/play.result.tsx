...
import type { ShareCardData, ShareFormat } from "@/features/typing/components/share-card"
...
export default function PlayResultRoute() {
  ...
  return (
    <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col items-center gap-4 px-4 py-6 sm:px-6">
      ...
      <div className="w-full" style={{ animationDelay: "300ms" }}>
        <ShareSection shareData={shareData} format={format} onFormatChange={setFormat} />
      </div>
